...
//  2. Rewrites the URL to target.URL + remainder + original query.
...
func rewriteRequest(slug string, target endpoint.Target) func(pr *httputil.ProxyRequest) {
	...
	return func(pr *httputil.ProxyRequest) {
		...
		// Combine the target base path with the remainder, avoiding "//".
