...
//   - Tier 2: full PII masking + local injection heuristic, fail-open
//   - Tier 3: all detectors + Azure Content Safety + post-validation, fail-closed
//
// References:
...
type Pipeline struct {
	// RunLocalMasking enables PII/PCI redaction on prompt messages.
